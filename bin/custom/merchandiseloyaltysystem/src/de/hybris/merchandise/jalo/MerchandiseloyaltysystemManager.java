...
/**
 * This is the extension manager of the Merchandiseloyaltysystem extension.
 */
public class MerchandiseloyaltysystemManager extends GeneratedMerchandiseloyaltysystemManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(MerchandiseloyaltysystemManager.class.getName());
	 ...
	 */
	public static MerchandiseloyaltysystemManager getInstance()
	{
		return (MerchandiseloyaltysystemManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				MerchandiseloyaltysystemConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MerchandiseloyaltysystemManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of MerchandiseloyaltysystemManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of MerchandiseloyaltysystemManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of MerchandiseloyaltysystemManager called, current tenant: " + getTenant().getTenantID());
		}
	}
