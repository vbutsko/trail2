package de.hybris.merchandise.loyaltysystem.hmc;
 ...
 */
public class LoyaltySystemHMCExtension extends HMCExtension {

    /** Edit the local|project.properties to change logging behavior (properties log4j.*). */
    @SuppressWarnings("unused")
    private static final Logger LOG = Logger.getLogger(LoyaltySystemHMCExtension.class.getName());

    /** Path to the resource bundles. */
    public final static String RESOURCE_PATH = "de.hybris.merchandise.loyaltysystem.hmc.locales";
